...
var vowels = function () 
{
    ...
    if(stringEntry === "")
    {
        alert("ERROR! Please enter a phrase, then click on the button.");
    }
    else
    {
        var intVowels = 0;
...
var stringEntry = $("phrase").value;
    ...
    if (stringEntry === "")
    {
        alert("AGAIN, ERROR! Please enter a phrase, then click on the button.");
    }
    else
    {
        var intConsonants = 0;
...
var reverse = function () 
{
    ...
    if (stringEntry === "")
    {
        alert("SERIOUSLY!!! MAJOR ERROR! Please enter a phrase, then click on the button.");
    }
    else
    {
        var stringReversed = "";
        ...
        $("output").value = "The reverse of your chosen phrase is: \n" + stringReversed; 
    }
}
