...
var fixPrinter = function() 
{
    ...
    //enter your if-statement code here and don't forget to send the output to the DOM
    ...
    if (boolPrinting === true) 
    {
        if (boolRedLight === true) 
        {
            ...
            {
                stringOutput = stringMessage2 + stringMessage3  + stringMessage4;  //True.true.true
            }                
        else
            
                stringOutput = stringMessage4 + stringMessage5; //true.true.false
        }
